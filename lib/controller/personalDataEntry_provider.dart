...
class PersonalDataEntryProvider extends ChangeNotifier {
    ...
    if (image == null || imageURL == '') {
      showDialog(
          ...
          builder: (_) =>  AlertDialog(
            title: Text(AppLocalizations.of(context)!.personalEntryScreenErrorDialogTitle),
            content: Text(AppLocalizations.of(context)!.personalEntryScreenErrorDialogContent),
          ));
        isLoading = false;
      notifyListeners();
      return;
  ...
  pickImage(ImageSource source) async {
    ...
    await FirebaseStorage.instance
        ...
        .putFile(image!);
        imageURL = await FirebaseStorage.instance.ref(
        'images/${FirebaseAuth.instance.currentUser!.phoneNumber}/$key.png')
        .getDownloadURL();
